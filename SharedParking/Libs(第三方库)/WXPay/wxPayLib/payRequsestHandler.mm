...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSString *)signStr title:(NSString *)ordertitle price:(NSString *)orderprice :(NSString *)prepID
{
    if ( prepID != nil) {
        //获取到prepayid后进行第二次签名
        ...
        [signParams setObject: prepID     forKey:@"prepayid"];
        //生成签名
