...
+ (instancetype)shareKeychainIDFA {
    static KeychainIDFA *shareKeychainIDFA;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        shareKeychainIDFA = [[KeychainIDFA alloc] init];
        assert(shareKeychainIDFA != nil);
    });
    
    return shareKeychainIDFA;
}
