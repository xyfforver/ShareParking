...
static iBListBlock _locationBlock;
static iBFailureBlock _failureBlock;
static iBStatusBlock _statusBlock;
...
- (void)updateLocationWithDistanceFilter:(CLLocationDistance)filter
            ...
            didChangeAuthorizationStatus:(iBStatusBlock)changedStatus
                      didUpdateLocations:(iBListBlock)located
                        didFailWithError:(iBFailureBlock)failed
{
...
- (void)locationManagerDidUpdateLocations:(iBListBlock)located
                         didFailWithError:(iBFailureBlock)failed
{
