...
static iBVoidBlock _completionBlock;
static UIViewController *_viewController;

@implementation UINavigationController (Block)

- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated onCompletion:(iBVoidBlock)completion
{
...
- (void)popToViewController:(UIViewController *)viewController animated:(BOOL)animated onCompletion:(iBVoidBlock)completion
{
    [self setCompletionBlock:completion viewController:viewController andDelegate:self];
    [self popToViewController:_viewController animated:animated];
}

- (void)popViewControllerAnimated:(BOOL)animated onCompletion:(iBVoidBlock)completion
{
...
- (void)popToRootViewControllerAnimated:(BOOL)animated onCompletion:(iBVoidBlock)completion
{
    NSUInteger index = [self.viewControllers indexOfObject:self.visibleViewController];
...
- (void)setCompletionBlock:(iBVoidBlock)completion viewController:(UIViewController *)viewController andDelegate:(id)delegate
{
