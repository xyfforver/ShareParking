...
static iBDismissBlock _dismissBlock;
static iBVoidBlock _cancelBlock;
static iBPhotoPickedBlock _photoPickedBlock;
                 ...
                 destructiveButtonTitle:(NSString *)destructiveButtonTitle
                         ...
                         disabledTitles:(NSArray *)disabledTitles
                             showInView:(UIView *)view
                              onDismiss:(iBDismissBlock)dismissed
                               onCancel:(iBVoidBlock)cancelled
{
...
+ (UIActionSheet *)photoPickerWithTitle:(NSString *)title
                      cancelButtonTitle:(NSString *)cancelButtonTitle
                          ...
                          onPhotoPicked:(iBPhotoPickedBlock)photoPicked
                               onCancel:(iBVoidBlock)cancelled
{
    if (![self canShowInView:view]) {
        return nil;
